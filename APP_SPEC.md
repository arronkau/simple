...
- The party title in the header is the switcher: it opens a list of every other indexed party, most recently opened first, each with when it was last opened (parties are often still called "New Party"), plus a New party action. Manage lists the same parties with the same dates and is where forget and delete live.
