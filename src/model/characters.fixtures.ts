...
export const CHARACTER_MANUAL_FIXTURES = [
  ...
  },
  {
    ...
    expected: {
      ...
      level: 1,
      saves: [
        { key: "doom", label: "Death", value: 12 },
        { key: "ray", label: "Wands", value: 13 },
        { key: "hold", label: "Paralysis", value: 14 },
        { key: "blast", label: "Breath", value: 15 },
        { key: "spell", label: "Spells", value: 16 },
      ],
    },
  },
  {
