...
import { RECORD_VISIBILITY_MANUAL_FIXTURES } from "./model/recordVisibility.fixtures";
...
import { RETRY_BACKOFF_MANUAL_FIXTURES } from "./persistence/retryBackoff.fixtures";
import {
  SYNC_WINDOW_LISTENERS_MANUAL_FIXTURES,
} from "./persistence/syncWindowListeners.fixtures";
import {
  ACTION_ROLE_STORE_MANUAL_FIXTURES,
  COIN_DRAG_TRANSFER_STORE_MANUAL_FIXTURES,
  DELETED_PARTY_CLEANUP_STORE_MANUAL_FIXTURES,
  ...
  PARTY_MANAGEMENT_STORE_MANUAL_FIXTURES,
